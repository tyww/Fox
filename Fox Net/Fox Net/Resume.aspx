<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Resume.aspx.cs" Inherits="Fox_Net.Resume" %>
...
<body style="background-color: #e6e0e0;">
    <div style="height: 100%; background-color: #e6e0e0">
        <div style="height: 60px; background-color: #808080;" class="main-div1">
            <div class="main-div2" style="background-color: #808080; height: 110px">
        ...
        <div id="Infomenu" style="height: 50px; background-color: #e6e0e0; font-size: 35px;" class="main-div1">
        ...
        <div style="height: auto; width: 1029px; margin: auto; margin-top: 15px; background-color: #e6e0e0;">
            ...
            <div style="height: 400px; margin-top: 15px; background-color: #e6e0e0;">
                <div style="width: 480px; height: 300px; margin: 0 auto; background-color: #e6e0e0;">
                    <div style="text-align: start; font-size: 22px; background-color: #e6e0e0;">
                        <asp:Label ID="Label20" runat="server" Text="自我评价(160个字)"></asp:Label>
                    </div>
                    &nbsp;
                            <div style="height: 500px; width: 420px; background-color: #e6e0e0;">
                                <textarea style="text-indent: 2em; font-size: 16px; width: 370px; height: 300px;" id="mess-input" name="message" maxlength="160"></textarea>
                                <button type="button" style="height: 32px; width: 40px; background-color: #e6e0e0; cursor: pointer; margin-top: 10%">保存</button>
                            </div>
                </div>
            </div>
        </div>
